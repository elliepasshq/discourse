  ...
  class AdminController < ::ApplicationController
    ...
    def show
      ...
      format_time = lambda do |value|
        ...
        time_zone =
          current_user&.user_option&.timezone.presence ||
          SiteSetting.default_timezone.presence ||
          "UTC"
      ...
      last_checked = ERB::Util.html_escape(
        format_time.call(connection["last_checked_at"])
      )

      last_success = ERB::Util.html_escape(
        format_time.call(connection["last_success_at"])
      )
